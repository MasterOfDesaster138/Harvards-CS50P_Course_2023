"""
    Title: Problemset_7 - Watch on YouTube
    ...
    Summary:
            ...
            click Share, and then click Embed, you’ll see HTML (the language in which web pages are written) like the below,
...
returns a “match object,” per docs.python.org/3/library/re.html#match-objects, wherein matches are 1-indexed,
...
def parse(s: str) -> str:
    ...
    pattern = r'(?i)<iframe(?:\s+\w+=\"[^\"]*\")*\s+src="(https?://(?:www\.)?youtube\.com/embed/[^\s\"]+)".*?</iframe>'
